  ...
  public static void main(String[] args) {
    ...
    while (decision==1 || decision==2) {
      ...
      if (decision==1) {
        ...
        int i = ordenSuma[0];
        int j = ordenSuma[1];
        System.out.println("Para escoger el tipo de su primer matriz: ");
        System.out.println("*Presione 1 Double + enter");
        System.out.println("*Presione 2 Float + enter");
        System.out.println("*Presione 3 Long + enter");
        System.out.println("*Presione 4 Integer + enter");
        System.out.println("*Presione 5 Short + enter");
        System.out.println("*Presione 6 Byte + enter");
        int seleccion=0;
        seleccion = Character.getNumericValue(usrEsbribe().charAt(0));
        ...
        if (seleccion==1){
          Matriz<Double> miMatriz1 = new Matriz<>();
          miMatriz1.arreglo = new Double[i][j];
        }
        else if (seleccion==2){
          Matriz<Float> miMatriz1 = new Matriz<>();
          miMatriz1.arreglo = new Float[i][j];
        }
        else if (seleccion==3){
          Matriz<Long> miMatriz1 = new Matriz<>();
          miMatriz1.arreglo = new Long[i][j];
        }
        else if (seleccion==4){
          ...
          Matriz<Short> miMatriz1 = new Matriz<>();
          miMatriz1.arreglo = new Short[i][j];
        }
        else if (seleccion==6){
          Matriz<Byte> miMatriz1 = new Matriz<>();
          miMatriz1.arreglo = new Byte[i][j];
        }else{
          Matriz<Integer> miMatriz1 = new Matriz<>();
          miMatriz1.arreglo = new Integer[i][j];
        }

        System.out.println("Para escoger el tipo de su segunda matriz: ");
        System.out.println("*Presione 1 Double + enter");
        System.out.println("*Presione 2 Float + enter");
        System.out.println("*Presione 3 Long + enter");
        System.out.println("*Presione 4 Integer + enter");
        ...
        if (seleccion==1){
          ...
          Matriz<Float> miMatriz2 = new Matriz<>();
          miMatriz2.arreglo = new Float[i][j];
        }
        else if (seleccion==3){
          Matriz<Long> miMatriz2 = new Matriz<>();
          miMatriz2.arreglo = new Long[i][j];
        }
        else if (seleccion==4){
          Matriz<Integer> miMatriz2 = new Matriz<>();
          miMatriz2.arreglo = new Integer[i][j];
        }
        else if (seleccion==5){
          Matriz<Short> miMatriz2 = new Matriz<>();
          miMatriz2.arreglo = new Short[i][j];
        }
        else if (seleccion==6){
          Matriz<Byte> miMatriz2 = new Matriz<>();
          miMatriz2.arreglo = new Byte[i][j];
        }
        else{
          Matriz<Integer> miMatriz2 = null;
          miMatriz2.arreglo = new Integer[i][j];
        }

        System.out.println("Para tu primer matriz");
